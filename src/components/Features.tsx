          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                key={index}
                whileHover={{ y: -8 }}
                className="group p-8 bg-[#FAF8F5] border border-gray-100 rounded-sm hover:bg-white hover:shadow-[0_20px_50px_rgba(0,0,0,0.06)] transition-all duration-300 cursor-pointer"
              >
